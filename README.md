...
`/v1/policy` supports guardrails such as `requireVerifiedSensitive` (verified sources for sensitive events) and `minSignalQuality` (force review when signal quality is weak).
